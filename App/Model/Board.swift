...
struct Board: Codable, Hashable {
    ...
    init(id: String, title: String, isFavorite: Int, groupId: String, type: Int, name: String, accessScore: Int? = nil, readOnly: Bool? = nil, sectionId: String? = nil, todayPostCount: Int? = nil, forbiddenReply: Bool? = nil, status: Int? = nil) {
        self.id = id
        self.title = title
...
extension Board {
    static func defaultBoard() -> [Board] {
        return [
            ...
            Board(id: "c2ea7c56020eb65b0f4dfc2a867d97e7", title: "房产", isFavorite: 0, groupId: "3d1a6f8d2521f6066507f2bc3cca2bf5", type: 0, name: "房产"),
